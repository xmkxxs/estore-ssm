...
public class Customer {
	...
	public Customer(int id, String userName, String password, String realName, String mobile, String email,
			String passwordQuestion, String passwordHintAnswer) {
		super();
		this.id = id;
		this.userName = userName;
		this.password = password;
	...
	public String toString() {
		return "Customer [id=" + id + ", userName=" + userName + ", password=" + password + ", realName=" + realName
				+ ", mobile=" + mobile + ", email=" + email + ", passwordQuestion=" + passwordQuestion
